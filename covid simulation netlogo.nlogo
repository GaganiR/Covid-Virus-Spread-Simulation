...
to setup-constants
  ...
  set sick-duration 20           ;; how long one stays sick in this model
...
to get-older ;; turtle procedure
  ...
  if infected? and number-asymptomatic-days < symptom-free-period [set number-asymptomatic-days number-asymptomatic-days + 1]
  if infected? and number-asymptomatic-days >= symptom-free-period
    [get-sick]
...
"healthy" 1.0 0 -10899396 true "" "plot count turtles with [ not sick? and not immune? and not infected? ]"
"infected" 1.0 0 -13791810 true "" "plot count turtles with [ infected? ]"
